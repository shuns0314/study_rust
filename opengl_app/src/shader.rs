...
impl Shader {
    ...
    pub fn new(vertex_path: &str, fragment_path: &str) -> Shader {
        ...
        let cstr_fragment_code: CString = CString::new(fragment_code.as_bytes()).unwrap();
    ...
    pub unsafe fn set_float(&self, name: &CStr, value: i32) {
        gl::Uniform1i(gl::GetUniformLocation(self.id, name.as_ptr()), value);
    }
    ...
    unsafe fn check_compile_errors(&self, shader: u32, type_: &str) {
        ...
        info_log.set_len(1024 - 1); // substract 1 to skip the trailing null character
        if type_ != "PROGRAM" {
            ...
            if success != gl::TRUE as GLint {
                ...
                println!(
                    "failed to compile shaer code: type={}, log={}",
